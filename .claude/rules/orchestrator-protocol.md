...
Plan approved → orchestrator activates
  ...
  │
  Step 2: VERIFY — Check Stata logs, compile LaTeX, confirm outputs
...
During the first few sessions, pause more frequently to check in with Christine so she can learn how the workflow operates. Gradually increase autonomy as patterns are established.
