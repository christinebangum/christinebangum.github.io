...
1. **Research value check** -- Does this improve the paper? If NO, don't build it.
2. **Create folder** -- `mkdir -p explorations/[name]/{code,output}` + README + SESSION_LOG.md
3. **Code immediately** -- no plan needed. Must-haves: code runs, results correct, goal documented. Not needed: full comments, perfect style.
