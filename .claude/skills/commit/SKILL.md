...
Do NOT stage `.claude/settings.local.json` or any files containing secrets or data.
...
- Exclude `settings.local.json`, data files, and sensitive files from staging
